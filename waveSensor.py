#Wave harmonics project from www.openbookproject.net/py4fun/wave/wave.html
import sys
from Tkinter import *
from math import *
...
class wave:
	...
	def plot (self, title = "??", pixHeight = None, maxY = None, others = []):
		if not pixHeight : picHeight = self.points * 2/3 #Nice ratio
